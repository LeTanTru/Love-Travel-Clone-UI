...
//Adjust bar price
const adjustBar =
    document.querySelector('#header-search__select-price--adjust-bar');
const price =
    document.querySelector('#header-search__select-price--heading-price--max');
...
const calendarInput =
    document.querySelector('#header-search__select--date-input');
...
const iconImgActives = ['./assets/img/icon-list-white.png',
    './assets/img/icon-menu-white.png'
]
const iconImgNotActives = ['./assets/img/icon-menu-white-opacity.png',
        './assets/img/icon-list-white-opacity.png'
    ]
    //Promotion Items Show/Hide 
const threeInRow =
    document.querySelector('.promotions__destinations-three-in-row');
const twoInRow =
    document.querySelector('.promotions__destinations-two-in-row');
const priceItem =
    document.querySelectorAll('.header-filter__pick-price--item');
const priceItemLength = priceItem.length;
const lowestList =
    document.querySelector('.promotions__destinations-lowest');
const highestList =
    document.querySelector('.promotions__destinations-highest');
const zToaList =
    document.querySelector('.promotions__destinations-z-to-a');
const aTozList =
    document.querySelector('.promotions__destinations-a-to-z');
const promotionItems =
    document.querySelector('.promotions__destinations-sale--off');
const displayPromotionItems =
    document.querySelector('.header-search__select-price--choose input[type="checkbox"]');
